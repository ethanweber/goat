...
function websocket_endpoint_from_url(url) {
    ...
    if (endpoint == "") {
        let message = "Please set a websocket endpoint. For example, a correct URL may look like the following: http://localhost:3000/visiongpu10.csail.mit.edu:8051";
...
class App extends Component {
    ...
    componentDidMount() {
        ...
        // 'command' for updates to the viewer
        this.state.client.onmessage = (cmd) => this.viewer_ref.current.handle_command(cmd.data);
