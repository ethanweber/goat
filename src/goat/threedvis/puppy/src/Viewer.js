...
export class Viewer extends Component {
    ...
    set_transform(path, matrix) {
        ...
        // check if camera, then update the controls (fix the coordinate system)
        // if (this.state.scene_tree.find(path).object instanceof THREE.Camera) {
        //     // console.log("fixing the camera frame");
        //     // this.state.scene_tree.find(path).object.rotateY(Math.PI);
        //     // this.state.scene_tree.find(path).object.rotateZ(Math.PI);
        //     this.state.controls.target.set(
        //         this.state.scene_tree.find(path).object.position.x,
        //         this.state.scene_tree.find(path).object.position.y,
        //         this.state.scene_tree.find(path).object.position.z
        //     ); // focus point of the controls
        // }
    }
    ...
    componentDidMount() {
        ...
        // Camera left
        this.state.camera_l = new THREE.PerspectiveCamera(120, this.state.viewport_width / this.state.viewport_height, 0.01, 100);
        ...
        // Controls left
        this.state.controls_l = new TrackballControls(this.state.camera_l, this.state.renderer_l.domElement);
    ...
    componentWillUnmount() {
        ...
        console.log("running will unmount");
    }
